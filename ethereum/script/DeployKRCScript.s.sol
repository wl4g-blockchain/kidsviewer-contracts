...
contract DeployRealEstateScript is Script {
  ...
  //     string
  //       memory metaURL = "https://api.bridgedataoutput.com/api/v2/OData/test/Property('P_5dba1fb94aa4055b9f29696f')?access_token=6baca547742c6f96a6ff71b138424f21";
  ...
  //     string
  //       memory priceURL = "https://api.bridgedataoutput.com/api/v2/OData/test/Property('P_5dba1fb94aa4055b9f29696f')?access_token=6baca547742c6f96a6ff71b138424f21";
  //     RealEstatePriceOracle realEstatePriceOracle = new RealEstatePriceOracle(network.functionsRouter, priceScript, priceURL);

  //     // Deploy LKToken
  //     LKToken lkToken = new LKToken(network.usdcUsdAggregator, network.usdcUsdFeedHeartbeatInterval, address(realEstatePriceOracle));
